...
本リポジトリは、非エンジニア（ただしIT/インターネット企業に勤めていて一定のリテラシーがある方）向けに、ChatGPT・Claude・Geminiといった LLM / 生成AI ツール群について説明し、業務効率化につなげるためのドキュメントを置く場所です。
...
- [7. 改めてGeminiを使いこなそう](docs/7-gemini-advanced.md)
- [8. ClaudeとClaude Code](docs/8-claude-and-claude-code.md)
