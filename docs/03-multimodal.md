...
ここで整理した素材を、生成AIの主要機能（チャット・アーティファクト・コネクタの3本柱）の中でどう扱うかは、[8章（生成AIでできること 共通編）](08-common-capabilities.md)で整理しています。スクリーンショットの読み取りやPDFの要約は、いずれも8章のチャット節で扱う「テキスト以外の入力もチャットの延長で扱える」場面の代表例です。
