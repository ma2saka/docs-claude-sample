...
確率で次の単語を選ぶだけの仕組みが、対話で人間らしい応答に近づくのは、3段階の学習を経るためです。
...
本ドキュメントではこれ以上の深追いはしません。モデルの中身は、魔法のような未知のメカニズムではなく、大量の文章で訓練され、人間の好みに合うよう調整された確率モデルです。以降の章はこの前提に立って書いてあります。
