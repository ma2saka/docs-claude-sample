...
ちなみに、「ここに自分の打った文章が混ざるのでは」という心配が湧いた人は、鋭い読者です。ただし業務利用での実情はかなり違います。[5章（「学習」というキーワードの誤解）](05-misunderstanding-learning.md)で、**あなたのチャット入力がモデル本体に焼き付くような現象は普段起きない**という話を、証拠と合わせて丁寧にほぐします。
...
入出力の組み合わせ方や、実務で抑えておきたい押さえどころは、独立した章にまとめてあります。詳しくは[3章（マルチモーダル）](03-multimodal.md)を参照してください。
