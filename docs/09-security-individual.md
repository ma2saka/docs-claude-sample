...
本章のゴールは、入力・出力・履歴の3つの箱を、自分の手元で迷いなく扱えるようになることです。ルールを丸暗記するよりも、3つの箱で何が起きうるかを理屈で押さえておくほうが、現場で判断がつきやすくなります。
...
- 組織側がなぜルールを敷くのか、その理屈と、エージェント時代に増える論点は [10章（セキュリティ エージェント時代のガバナンス）](10-security-agent-era.md) で扱う
