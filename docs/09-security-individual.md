...
組織側がなぜルールを敷くのかという背景と、エージェント時代に追加で気にする論点は[10章](10-security-agent-era.md)で扱います。本章の射程外として、提供事業者のクラウドにそもそも渡さない経路を選択肢に加える場合は、[Appendix: ローカルLLM](appendix-local-llm.md)で位置づけを扱っています。
