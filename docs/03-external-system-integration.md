...
本文へ進む前に、以降繰り返し登場する語を一行ずつ置いておきます。厳密な定義や周辺知識は[6章（用語集）](06-terminology.md)で扱います。ここでは、**本章を読み進めるあいだ迷子にならない程度の目印**として眺めてください。
...
読み進めていて「この語、もう少し広い文脈で押さえたい」と感じたら、6章をひらいて該当項目を読めば、そのまま本章に戻れます。
