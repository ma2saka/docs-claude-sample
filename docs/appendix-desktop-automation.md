...
入力と出力の範囲がフロー定義の段階で決まるため、想定外の操作が発生しにくい構成です。3アプローチでは最初の検討候補に当たります。
...
費用対効果の目安としては、頻度が週1回以上、所要時間が1回あたり5分以上、手順の構造がほぼ固定されている作業が候補になります。1回数分で終わる作業に画面操作エージェントを当てる組み方は、トークン費用が削減量を上回りやすくなります。
