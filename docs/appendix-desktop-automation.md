...
なお、AnthropicのComputer Useは2026年4月のClaude Opus 4.7のGAで、扱える画面解像度の上限と、1回の依頼で割り当てられるターン数・計算リソースが引き上げられました。文字の小さなUIや複数手順をまたぐ操作で、取り違えが起きにくくなったとの観察が共有されています（最終確認：2026-05-16）。
