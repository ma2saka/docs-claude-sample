...
利用者の感覚としては、「グラウンディングはRAGをGoogle側の文脈で呼び直したもの」と理解しておくと、製品の説明文を読み解きやすくなります。一方で、Geminiのグラウンディング機能を使う場合は、利用条件として検索候補の表示が求められるなど、Google側の運用ルールに従う必要があります。利用にあたっては、Geminiの公式ドキュメントで条件を確認しておきます。
