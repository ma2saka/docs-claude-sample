...
- [5章](05-misunderstanding-learning.md)で「学習」の3区分（事前学習・ファインチューニング・コンテキスト／メモリ）を読み、社内文書を参照させる仕組みがそのどれと違うのかを整理したい人
...
利用者として押さえておきたいのは、「検索で何が引かれたか」を確認する習慣です。多くの製品は、引用元の文書名やURLを返してきます。回答が外れたときは、まず検索結果の段階でずれていないかを見ると、原因の切り分けが進めやすくなります。プロンプトの言い換えで改善することも多く、[6章](06-hallucination-and-knowledge-literacy.md)で触れた「揺らぎテスト」と組み合わせて使える手順です。
