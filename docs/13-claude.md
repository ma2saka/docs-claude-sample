...
[11章](11-gemini-advanced.md)で扱ったGeminiの保存済み情報と役割が近く、どちらも個人の好みや事実情報を会話をまたいで保持し、毎回同じ前提を伝え直す手間を省く仕組みです。Geminiが保存済み情報とGemsの2層で構成されるのに対し、Claude側は本章のProjects・メモリ・スタイルの3層で構成され、本節のメモリはそのうち個人向けの一系統にあたります。
