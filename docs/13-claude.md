...
- Claudeを業務で使い始めており、使い分けの軸を整理したい人。まだ触ったことがない場合は、次節の手順で最初の会話を試してから読み進める
...
## Claudeに初めて触るときは、ブラウザでアカウントを作って会話を試す

[1章](01-gemini-in-workspace.md)ではGeminiを入口としてハンズオンを進めました。Claudeをまだ触っていない場合は、本章の機能解説へ入る前に、同じ要領で短い会話を数回試しておきます。
