...
- いずれの能力もツール呼び出しを基盤として組み立てられている
- どの能力で扱う依頼かを最初に切り分けておくと、プロンプトと段取りの両方を整理しやすくなる

個別サービスの機能差や料金・制限は、[11章](11-gemini-advanced.md)以降のサービス別章で扱います。

次は[9章（セキュリティ 個人利用編）](09-security-individual.md)で、3本柱を実際に使うときに押さえておきたい入出力と履歴の扱いに進みます。
