...
社内で「このツールは禁止」「この使い方だけ許可」というルールに出くわすと、利用者側からは窮屈に見える場面があります。ここでは「組織は何を気にしているのか」を、ひとまとまりの部署名でくくらず、**観点ごとに分けて**眺めてみます。観点と分担を分けて見ると、自分が手元で気にすべきことと、組織側が引き受けてくれていることの境目がはっきりします。

組織内で実際にどの担当が引き受けるかは、IT、セキュリティ、法務、総務など、企業によって分担の名前が変わります。ここでは「役割」として並べておきます。
