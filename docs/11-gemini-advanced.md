...
カスタム指示の組み立て方は[Appendix: プロンプトの組み立て方](appendix-prompting.md)で具体的なパターンとテンプレートを扱っています。
