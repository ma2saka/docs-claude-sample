...
- 4章で、AIが外部ツールを呼び出す流れをざっくり把握した人
- まだ読んでいない単語が出てきたら、7章（用語）に戻って確認できると思っていただいて構いません
...
ここで押さえておきたいのは、**どれもモデルの重みには触らない**ということです。書き込まれるのは、モデルの外側にある記憶領域だけです。7章で紹介した「机の上の資料の山」の比喩で言えば、事前学習は脳そのものの発達、メモリは机に追加した付箋だと思ってください。
