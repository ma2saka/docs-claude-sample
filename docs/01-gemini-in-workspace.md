...
理屈の前に、まずは触ってみます。本章は、[0章](0-overview.md)でお渡しした地図を脇に置いて、最初の一歩を具体的な操作に落とし込むためのハンズオンです。Google Workspaceを普段使いしている皆さんなら、追加のインストールもほぼいらないまま、Geminiと30分ほど会話する体験まで進めます。
...
社外秘のドキュメントを扱う場合の作法は[8章](8-security-individual.md)で整理します。ここでは、まず「サイドパネルが、思ったより手の届くところにある」という事実を体感してください。
...
プロンプトの書き方の理屈は[7章](7-common-capabilities.md)でまとめます。ここでは、「頼み方で返答が大きく変わる」という感覚が掴めれば、この章の目的は果たしたことになります。
